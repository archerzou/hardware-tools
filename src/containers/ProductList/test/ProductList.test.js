...
describe('Product List component', () => {
  ...
  describe('product filters', () => {
    it('should render filter options when useProducts Hook and useDepartments Hook return data', async () => {
      ...
      const filterDeptCount =
        document.getElementsByClassName('filter-data')[0].children;
      const filterBrandCount =
        document.getElementsByClassName('filter-data')[1].children;
